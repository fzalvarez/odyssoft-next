...
const timelineDotVariants = cva(
  "relative z-10 flex size-[var(--timeline-dot-size)] shrink-0 items-center justify-center rounded-full border-2 bg-[rgb(var(--background))]",
  {
    variants: {
      status: {
    ...
    compoundVariants: [
      {
        ...
        isAlternateRight: false,
        class:
          "absolute -right-[calc(var(--timeline-dot-size)/2-var(--timeline-connector-thickness)/2)] bg-[rgb(var(--background))]",
      },
      {
        variant: "alternate",
        orientation: "vertical",
        isAlternateRight: true,
        class:
          "absolute -left-[calc(var(--timeline-dot-size)/2-var(--timeline-connector-thickness)/2)] bg-[rgb(var(--background))]",
      },
      {
        variant: "alternate",
        orientation: "horizontal",
        class: "row-start-2 bg-[rgb(var(--background))]",
      },
      {
        variant: "alternate",
        status: "completed",
